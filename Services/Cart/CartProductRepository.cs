...
namespace Services.Cart
{
    public class CartProductRepository : ICartProductRepository
    {
        ...
        */
        public IEnumerable<CartProducts> GetCartProducts(long userId)
        {
            try
            {
        ...
        */
        public void DeleteProduct(int productId, long userId)
        {
            try
            {
        ...
        */
        ...
        /*
        Usage   : Get the user name from register
        Input   : current user Id
        Output  : Return current user firstname
        */
        public string GetUserName(long userId)
        {
            return db.Register.Where(u=> u.Id==userId).FirstOrDefault()?.firstName;
        }
    }
}
